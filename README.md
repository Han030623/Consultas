# Consultas
Este proyecto es una aplicación de escritorio desarrollada en Python utilizando la librería **CustomTkinter**. El objetivo es proporcionar una interfaz para consultar datos estadísticos sobre cómo las redes sociales afectan a los jóvenes, basándose en un conjunto de datos (CSV).
